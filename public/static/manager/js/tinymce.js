...
function addTinymceEditor($content) {
    ...
    var options = {
        ...
        toolbar: "undo redo | formatselect |bold italic underline  formatgroup  | alignleft aligncenter alignright alignjustify | paragraphgroup | table link image media emoticons insertgroup",
        toolbar_groups: {
            formatgroup: {
                icon: 'format',
                tooltip: 'Định dạng',
