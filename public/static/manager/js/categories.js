Category = {
    ...
    getCategoryMap: function (id) {
        if (id == 0) return [this.defaultParent];
        var list = [];
        var data = {};
        var self = this;
        let max = -1;
...
$(function () {
    ...
    else if (typeof category_map_data != "undefined") {
        Category.init({
            categories: category_map_data.map,
            defaultParent: category_map_data.default_parent
        });
    }
