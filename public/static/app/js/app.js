 ...
 */
    ...
    App.fn = App.prototype.fn = function () {
        ...
        this.openWindow = function (url, title, width, height, x, y) {
            ...
            var wo = window.open(url, title, 'targetWindow,toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=' + width + ',height=' + height + ',top=' + top + ',left=' + left);
            return wo;
        };
        var a = this;
        var st = {};
