...
(function ($) {
    ...
    $(".sidebar-menu .has-sub > a").append('<span class="acc-menu">+</span>');
        $(".sidebar-menu .has-sub > a").on("click", function (event) {
            
            if($(event.target).is('.acc-menu')){
                event.preventDefault();
                $(".sidebar-menu .has-sub > a")
                    .removeClass("active")
                    .find("span")
                    .replaceWith('<span class="acc-menu">+</span>');
                $(".sidebar-menu .sub-menu").slideUp("normal");
    ...
    if (contentwidth <= "1200") {
        $(".dropdown>.menu-title").append('<span class="according-menu">+</span>');
        $(".dropdown>.menu-title").on("click", function (event) {
            
            if($(event.target).is('.according-menu')){
                event.preventDefault();
                $(".dropdown>.menu-title")
                    .removeClass("active")
                    .find("span")
    ...
    $(".search-box").on("click", function () {
        $(this).closest("header").find(".search-full").addClass("open");
    });
    $(window).on("load resize", function () {
        ...
        $(".close-search").on("click", function () {
            $(this).closest(".search-full").removeClass("open");
        });
