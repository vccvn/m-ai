function CrazySelect(selector, template) {
    ...
    this.init = function () {
        ...
        $el.find('.dropdown-menu').on('click', function (e) {
            ...
            if (tag != 'a') {
                ...
                } else if ($elm.hasClass('crazy-select-advance-button')) {
                    App.func.call(self.advanceHandler, [self.$searchInput.val()]);
                    self.$searchInput.val('');
                }else if($elm.hasClass('btn-advance')){
                    e.stopPropagation();
                    App.func.call($elm.data('call'), [el]);
                }
            }
        });
    };
    ...
    this.ajaxSearch = function (keyword, callback) {
        ...
        return App.api.get(this.searchUrl, data).then(function (rs) {
            if (rs.status) {
                if (rs.data) {
                    self.hideLoader();
                    // do something
    ...
    /**
     * get optiom
     * @param {*} options du lieu dau vao
     * @param {string|number} defaultVal gia tri mac dinh
     * @param {string} html
     * @param {number} level
    ...
    /**
     * thay doi gia tri
     * @param {number|string} value gia tri mới
     */
