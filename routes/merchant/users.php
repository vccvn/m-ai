...
use App\Http\Controllers\Merchant\General\AgentController;
use App\Http\Controllers\Merchant\General\CIController;
use App\Http\Controllers\Merchant\General\UserController;
...
Route::controller(UserController::class)->group(function(){
    $master = merchant_routes(null, true, true, true, null, "Quản lý Người dùng", "Cho phép thêm / sửa / xóa thông tin người dùng");
    /**
     * ----------------------------------------------------------------------------------------------------------------------------
...
Route::prefix('agent')->controller(AgentController::class)->name('.agent')->group(function(){
    $master = merchant_routes(null, true, true, true, null, "Quản lý Agent", "Cho phép thêm / sửa / xóa thông tin agent");
