...
use App\Http\Controllers\Merchant\General\FileController;
use Illuminate\Support\Facades\Route;


Route::controller(FileController::class)->group(function(){
    $master = merchant_routes(null, true, true, true, null, "Quản lý file", "Cho phép thêm sửa xóa các file media để chèn vào nội dung sản phẩm, bài viết");
    /**
     * --------------------------------------------------------------------------------------------------------------------
