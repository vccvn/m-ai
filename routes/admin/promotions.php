...
use App\Http\Controllers\Admin\Promotions\CampaignController;
use App\Http\Controllers\Admin\Promotions\VoucherController;
use Illuminate\Support\Facades\Route;
$master = ModuleManager::addModule('admin', 'promotions', [
...
Route::prefix('campaigns')->name('.campaigns')->controller(CampaignController::class)->group(function () use($master) {
    ...
    $sub = admin_routes(null, true, true, true, null, 'Quản lý Chiến dịch khuyến mãi', 'Cho phép xem các Chiến dịch quảng cáo', $master);
...
Route::prefix('vouchers')->name('.vouchers')->controller(VoucherController::class)->group(function () use($master) {
    ...
    $sub = admin_routes(null, true, true, true, null, 'Quản lý Voucher', 'Cho phép quản lý các voucher', $master);
