...
Route::middleware(['check.device'])->prefix('ai')->name('ai.')->group(function(){
    ...
    Route::controller(ChatController::class)->prefix('chat')->name('chat.')->middleware('web.auth')->group(function(){
    ...
    Route::controller(TopicController::class)->prefix('chuyen-de')->name('topics.')->middleware('web.auth')->group(function(){
