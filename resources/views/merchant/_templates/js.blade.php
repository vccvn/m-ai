		...
		<div class="copy-text-widget" style="position: absolute; right: 0; bottom: 0; opacity: 0.01;">
			<input type="text" name="copyable" id="copuable-input" />
		</div>
		<script src="{{asset('static/manager/assets/vendors/base/vendors.bundle.js')}}" type="text/javascript"></script>
		<script src="{{asset('static/manager/js/script.js')}}" type="text/javascript"></script>
