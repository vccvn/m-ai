                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        @include($_base.'forms.templates.crazyselect', [
                            'input' => html_input([
                                ...
                                'name' => 'payment_id',
                                'id' => 'payment_id',
                                'default' => $request->payment_id,
                                // 'class' => 'form-control m-input',
                                'data' => get_payment_method_id_options([],'Chọn phương thức thanh toán')
                            ])
                        ])
                    </div>
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        @include($_base.'forms.templates.crazyselect', [
                            'input' => html_input([
                                ...
                                'name' => 'status',
                                'id' => 'status',
                                'default' => strlen($request->status) == 0? 'all': $request->status,
                                // 'class' => 'form-control m-input',
                                'data' => get_order_status_options("Trạng thái đơn hàng")
                            ])
                        ])
                    </div>
