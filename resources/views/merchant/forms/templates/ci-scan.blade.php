<div class="custom-file preview">
    ...
    <img src="{{$input->value?route('merchant.users.ci.image', ['user_id' => $input->parent?$input->parent->hidden_id->val():0, 'face' => $input->hidden('face')]): asset('static/images/default.png')}}" alt="" class="img-preview">
    {!! $input !!}
