...
@section('content')
        ...
        <div class="form-upload-block">
            <div class="row">
                <div class="col-12 col-md-8 ml-auto mr-auto">
                    ...
                    @if ($er = $errors->first())
                        <div class="alert alert-error text-center mt-2 mb-3">
                            {{$er}}
                        </div>
                    @endif
                    <div class="upload-available-total text-center mt-3 mb-2">Số file còn lại: <span class="upload-file-left">{{ $user->upload_count }}</span></div>
                    <div class="text-center">
                        <a href="{{ route('merchant.payments.requests.create') }}" class="btn btn-info">Đăng ký thêm lượt tải</a>
                    </div>
                </div>
            </div>
        ...
        <div class="form-upload-block">
            <div class="row">
                <div class="col-12 col-md-8 ml-auto mr-auto">
                    ...
                    <div class="alert alert-warning text-center mt-3 mb-3">
                        Bạn đã hết lượt tải lên
                    </div>

                    <div class="text-center">
                        <a href="{{ route('merchant.payments.requests.create') }}" class="btn btn-info"><i class="fa fa-plus"></i> Đăng ký thêm lượt tải</a>
                    </div>
    ...
    <div id="info-form" class="d-none">
        <form method="POST" action="{{ route($route_name_prefix . '3d.models.save') }}" id="model-info-form" enctype="multipart/form-data">
            @csrf
                            ...
                            <div>
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6 col-lg-8 col-xl-8">
                                        ...
                                        <div class="mt-1 mb-4 crazy-form-group  " id="tracking_image_file-form-group">
                                            <label class="" for="tracking_image_file">
                                                File ảnh tracking (rộng tối thiểu 1000px, cao tối thiểu 1000px)
                                            ...
                                            <div class="">
                                                ...
                                                <div class="custom-file">
                                                    <input type="file" name="tracking_image_file" id="tracking_image_file" class="custom-file-input" placeholder="Viết gì đó">
                                                    <label class="custom-file-label" for="tracking_image_file" data-label="Chọn file">Chưa có file nào được chọn</label>
                                                </div>


                                                <div class="form-control-feedback input-message-alert" id="input-tracking_image_file-message-alert"></div>

                                            </div>

                                        </div>
                                        <input type="hidden" name="nft_file_data" id="nft_file_data" class="form-control m-input">
    ...
    @include($_template . 'mindar-events')
@endsection
@section('jsinit')
    <script>
        window.__upload_total__ = {{ $user->upload_count }};
    </script>
@endsection
@section('js')
