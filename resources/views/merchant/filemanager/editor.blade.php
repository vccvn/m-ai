...
@section('content')
    ...
    <!--begin::Portlet-->
    <div class="m-portlet">
        <form method="post" action="{{ route($route_name_prefix.'filemanager.files.save') }}" class="m-form m-form--fit m-form--label-align-right crazy-form">
            @csrf
                ...
                <div class="m-portlet__head-tools">
                    <ul class="m-portlet__nav">
                        ...
                        <li class="m-portlet__nav-item">
                            <a href="{{ route($route_name_prefix.'filemanager') . '?p=' . $path }}" data-toggle="m-tooltip" data-placement="top" title data-original-title="Quay về" class="ml-2 btn-make-dir btn btn-outline-warning m-btn btn-sm"><i class="fa fa-arrow-left"></i> <span class="d-none d-md-inline-block">Quay về</span></a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="m-portlet__foot m-portlet__foot--fit">
                <div class="m-form__actions" class="text-center">
                    ...
                    <a class="btn btn-secondary" href="{{ route($route_name_prefix.'filemanager') . '?p=' . $path }}">Huỷ</a>
                </div>
            </div>
        </form>
