<div class="banh-info  pb-3">
    ...
    @endphp
    @if ($transfer && ($cfg = crazy_arr($transfer->config)))
...
<div class="guide">
    ...
    <div class="guide-step">
        <h4>Bước 1:</h4>
        <p>Chuyển khoản với nội dung: {{isset($order)?$order->billing->phone_number:'Số điện thoại'}} + {{isset($order)?$order->code:'Mã đơn hàng'}}</p>
    </div>
    <div class="guide-step">
        <h4>Bước 2:</h4>
