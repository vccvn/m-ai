...
?>
<!-- product item -->
<div class="style-set-item style-set-product-item row {{$hasError?'has-danger':''}}" id="style-set-item-{{$index}}">
    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-2">
        <div class="product-image">
            <img src="{{$product->getFeaturedImage()}}" class="product-thumbnail">
        </div>
    </div>
    <div class="col-sm-6 col-md-8 col-lg-9 col-xl-10">
        ...
        <div class="d-flex">
            ...
            <div class="buttons ml-auto">
                <a href="javascript:void(0);" data-index="{{$index}}" data-toggle="m-tooltip" data-placement="right" data-original-title="Xóa san phẩm" class="btn-delete-style-set-product-item text-danger btn btn-outline-danger btn-sm m-btn m-btn--icon m-btn--icon-only m-btn--pill m-btn--air">
