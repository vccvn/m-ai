                    ...
                    <div class="m-portlet__head-tools">
                        <ul class="m-portlet__nav">
                            <li class="m-portlet__nav-item">
                                <a href="{{route($route_name_prefix.'filemanager') . '?p=' . $relativePath}}" data-toggle="m-tooltip" data-placement="top" title data-original-title="Quay về" class="ml-2 btn btn-outline-warning m-btn btn-sm"><i class="fa fa-arrow-left"></i> <span class="d-none d-md-inline-block">Quay về</span></a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="m-section">
                        <div class="m-section__content">
                            ...
                            <div class="text-center mt-3">
                                <a href="{{route($route_name_prefix.'filemanager') . '?p=' . $relativePath}}" data-toggle="m-tooltip" data-placement="top" title data-original-title="Quay về" class="btn btn-primary m-btn btn-sm"><i class="fa fa-arrow-left"></i> Quay về</a>
                            </div>
