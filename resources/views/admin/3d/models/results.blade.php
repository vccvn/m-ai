...
@if (count($results))
    <div class="list-model crazy-list">
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-lg-4 col-xl-3" id="crazy-item-{{$item->id}}" data-name="{{$item->name}}">
        ...
        <div class="row">
            <div class="col-3">
                <a class="btn m-btn--pill m-btn--air m-btn--icon m-btn--icon-only        btn-outline-primary btn-sm" href="{{route($route_name_prefix.'3d.models.upload')}}" data-toggle="m-tooltip" data-placement="right" data-original-title="Tải lên file mới"><i class="fa fa-plus"></i></a>
