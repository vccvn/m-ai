...
?>
    ...
    <meta http-equiv="description" content="@yield('meta_description', $__env->yieldContent('description'))" />
    <meta http-equiv="keywords" content="@yield('keywords', $siteinfo->keywords)">
    <!-- /http-equive -->


    <meta name="title" content="@yield('meta_title', $web_title)">
    <meta name="description" content="@yield('meta_description', $__env->yieldContent('description'))">
    ...
    <meta property="og:description" content="@yield('meta_description', $__env->yieldContent('description'))" />
