...
<!-- Mirrored from dreamschat.dreamstechnologies.com/template-html/template2/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 17 Dec 2023 10:28:44 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <div class="main-wrapper">
        ...
        <div class="content main_content">
            ...
            <div class="sidebar-menu">
                <div class="logo-col">
                    <a href="index.html"><img src="{{sub_asset('ai/chat/assets/img/logo.png')}}" alt=""></a>
                </div>
                <div class="menus-col">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="#" class="chat-profile-icon" data-bs-toggle="dropdown">
                                    <img src="{{sub_asset('ai/chat/assets/img/avatar/avatar-13.jpg')}}" alt="">
                                </a>
                           ...
                           <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="top-contacts-box">
                                            <div class="profile-img online">
                                                <img src="{{sub_asset('ai/chat/assets/img/avatar/avatar-8.jpg')}}" alt="">
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="top-contacts-box">
                                            <div class="profile-img online">
                                                <img src="{{sub_asset('ai/chat/assets/img/avatar/avatar-7.jpg')}}" alt="">
                                            </div>
                                            <div class="profile-name">
                                                <span>Prince</span>
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="top-contacts-box">
                                            <div class="profile-img online">
                                                <img src="{{sub_asset('ai/chat/assets/img/avatar/avatar-3.jpg')}}" alt="">
                                            </div>
                                            <div class="profile-name">
                                                <span>Maria</span>
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="top-contacts-box">
                                            <div class="profile-img online">
                                                <img src="{{sub_asset('ai/chat/assets/img/avatar/avatar-4.jpg')}}" alt="">
                                            </div>
                                            <div class="profile-name">
                                                <span>Prince</span>
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="top-contacts-box">
                                            <div class="profile-img online">
                                                <img src="{{sub_asset('ai/chat/assets/img/avatar/avatar-2.jpg')}}" alt="">
                                            </div>
                                            <div class="profile-name">
                                                <span>Maria</span>
                                            </div>
                            ...
                            <ul class="user-list mt-2">
                                <li class="user-list-item">
                                    <div class="avatar avatar-online">
                                        <img src="{{sub_asset('ai/chat/assets/img/avatar/avatar-8.jpg')}}" class="rounded-circle" alt="image">
                                    </div>
                                ...
                                <li class="user-list-item">
                                    <div>
                                        <div class="avatar avatar-away">
                                            <img src="{{sub_asset('ai/chat/assets/img/avatar/avatar-9.jpg')}}" class="rounded-circle" alt="image">
                                        </div>
                                    </div>
                                    <div class="users-list-body">
                                        <div>
                                ...
                                <li class="user-list-item item-typing">
                                    <div>
                                        <div class="avatar avatar-online">
                                            <img src="{{sub_asset('ai/chat/assets/img/avatar/avatar-10.jpg')}}" class="rounded-circle" alt="image">
                                        </div>
                                    </div>
                                    <div class="users-list-body">
                                        <div>
                                ...
                                <li class="user-list-item">
                                    <div>
                                        <div class="avatar avatar-online">
                                            <img src="{{sub_asset('ai/chat/assets/img/avatar/avatar-11.jpg')}}" class="rounded-circle" alt="image">
                                        </div>
                                    </div>
                                    <div class="users-list-body">
                                        <div>
                                ...
                                <li class="user-list-item">
                                    <div>
                                        <div class="avatar avatar-away">
                                            <img src="{{sub_asset('ai/chat/assets/img/avatar/avatar-2.jpg')}}" class="rounded-circle" alt="image">
                                        </div>
                                    </div>
                                    <div class="users-list-body">
                                        <div>
                                ...
                                <li class="user-list-item">
                                    <div>
                                        <div class="avatar avatar-away">
                                            <img src="{{sub_asset('ai/chat/assets/img/avatar/avatar-12.jpg')}}" class="rounded-circle" alt="image">
                                        </div>
                                    </div>
                                    <div class="users-list-body">
                                        <div>
                                ...
                                <li class="user-list-item">
                                    <div>
                                        <div class="avatar avatar-online">
                                            <img src="{{sub_asset('ai/chat/assets/img/avatar/avatar-4.jpg')}}" class="rounded-circle" alt="image">
                                        </div>
                                    </div>
                                    <div class="users-list-body">
                                        <div>
                        ...
                        <div class="messages">
                            <div class="chats">
                                <div class="chat-avatar">
                                    <img src="{{sub_asset('ai/chat/assets/img/avatar/avatar-8.jpg')}}" class="rounded-circle dreams_chat" alt="image">
                                </div>
                            ...
                            <div class="chats chats-right">
                                ...
                                <div class="chat-avatar">
                                    <img src="{{sub_asset('ai/chat/assets/img/avatar/avatar-12.jpg')}}" class="rounded-circle dreams_chat" alt="image">
                                </div>
                                            ...
                                            <ul>
                                                <li>
                                                    <div class="image-download-col">
                                                        <a href="{{sub_asset('ai/chat/assets/img/chat-download.jpg')}}" data-fancybox="gallery" class="fancybox">
                                                            <img src="{{sub_asset('ai/chat/assets/img/chat-download.jpg')}}" alt="">
                                                        </a>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="sidebar">
                            ...
                            <ul class="user-list mt-2">
                                <li class="user-list-item">
                                    <div class="avatar avatar-online">
                                        <img src="{{sub_asset('ai/chat/assets/img/avatar/avatar-1.jpg')}}" class="rounded-circle" alt="image">
                                    </div>
                            ...
                            <ul class="user-list mt-2">
                                <li class="user-list-item">
                                    <div class="avatar avatar-online">
                                        <img src="{{sub_asset('ai/chat/assets/img/avatar/avatar-3.jpg')}}" class="rounded-circle" alt="image">
                                    </div>
                                    <div class="users-list-body align-items-center">
                                        <div>
                                            <h5>Craig Smiley</h5>
                        ...
                        <div class="call-box incoming-box">
                            <div class="call-wrapper">
                                <div class="call-inner">
                                    <div class="call-user">
                                        <img alt="User Image" src="{{sub_asset('ai/chat/assets/img/avatar/avatar-8.jpg')}}" class="call-avatar">
...
<!-- Mirrored from dreamschat.dreamstechnologies.com/template-html/template2/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 17 Dec 2023 10:29:16 GMT -->
</html>
