...
class ItemValidator extends BaseValidator
{
    ...
    public function rules()
    {
        ...
        $rules = [
            ...
            'icon'                         => 'mixed|max:180',
            'class'                        => 'mixed|max:180',
            'link_class'                   => 'mixed|max:180',
            'active_key'                   => 'mixed|max:180',
            'target'                       => 'mixed|max:180',
            'show_submenu'                 => 'mixed|max:180'
        ];
        switch ($this->type) {
            case 'url':
                $rules['text'] = $this->icon?'mixed|max:180':'required|max:180';
                $rules['url'] = 'required';
                break;
            ...
            default:
                if(array_key_exists($this->type, $this->refTypes)){
                    ...
                    if($this->text) $rules['text'] = 'mixed|max:180';
                }
