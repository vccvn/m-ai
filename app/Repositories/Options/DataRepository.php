...
class DataRepository extends BaseRepository
{
     ...
     */
    public function createListData(string $group_id, array $list = [], $check_group_exists = true) : array
    {
     ...
     * @return App\Models\OptionData[]
     */
    public function createListWithOwnerID($owner_id = 0, $group_id = 0, array $list = [], $check_group_exists = true) : array
    {
        if(!$this->checkInputs($group_id, $list, $check_group_exists)) return [];
        $output = [];
     ...
     * @return bool
     */
    public function checkInputs(string $group_id = '', array $list = [], $check_group_exists = true) : bool
    {
     ...
     * @return bool
     */
    public function sortItems($group_id, array $items = [])
    {
        $status = true;
