...
use App\Masks\Customers\CustomerCollection;
use App\Masks\Customers\CustomerMask;
...
{
    protected $validatorClass = CustomerValidator::class;
    protected $maskClass = CustomerMask::class;
    protected $maskCollectionClass = CustomerCollection::class;
    ...
    public function getCurrentCustomer()
    {
        ...
        $this->currentCustomer = ($id = $this->getSessionCookieCustomerId()) ? $this->findBy('id', $id) : (
            ($user = auth()->user()) ? $this->findBy('user_id', $user->id) : null
        );
