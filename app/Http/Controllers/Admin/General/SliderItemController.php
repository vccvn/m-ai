...
use Gomee\Engines\ViewDataEngine;
...
class SliderItemController extends AdminController
{
     ...
     * @param string $slider
     * @param string $id
     * @return ViewDataEngine
     */
    public function getUpdateItemForm(Request $request, $slider = null, $id = null) {
        return $this->getUpdateForm($request, $id);
    }
