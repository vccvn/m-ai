...
use App\Validators\Options\SortSettingItemValidator;

/**
 * config
 * @property-read GroupRepository $groupRepository
 * @property-read DataRepository $dataRepository
 * @property-read SettingRepository $repository
 */
class SettingController extends AdminController
{
    ...
    public function sortItems(Request $request)
    {
        ...
        elseif (!($validator = $this->dataRepository->validator($request, SortSettingItemValidator::class)) || !$validator->success()){
    ...
    */
    public function deleteItem(Request $request, $group)
    {
        ...
        elseif (!($item = $this->dataRepository->first(['group_id' => $group->id, 'can_delete' => 1, 'id'=>$request->id??$request->id]))) {
