...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'merchant.share' => \App\Http\Middleware\MerchantShareData::class,
        'merchant.access' => \App\Http\Middleware\MerchantAuthMiddleWare::class,
        ...
        'web.auth' => \App\Http\Middleware\ClientAuth::class,
